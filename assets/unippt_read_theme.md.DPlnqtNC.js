import{_ as i,c as n,I as l,j as s,a as p,a6 as h,o as t,bm as k,D as e}from"./chunks/framework.V0McN4Tf.js";const D=JSON.parse('{"title":"自定义系统级主题方案","description":"","frontmatter":{"navbar":false},"headers":[],"relativePath":"unippt/read/theme.md","filePath":"unippt/read/theme.md","lastUpdated":1729841289000}'),E={name:"unippt/read/theme.md"},r=s("h1",{id:"自定义系统级主题方案",tabindex:"-1"},[p("自定义系统级主题方案 "),s("a",{class:"header-anchor",href:"#自定义系统级主题方案","aria-label":'Permalink to "自定义系统级主题方案"'},"​")],-1),o=h(`<p>为了将系统主题定制功能交还用户，本项目采用默认值实现的主题，用户只需要提供指定名称变量，即可覆盖默认效果：</p><h2 id="可配置主题名" tabindex="-1">可配置主题名 <a class="header-anchor" href="#可配置主题名" aria-label="Permalink to &quot;可配置主题名&quot;">​</a></h2><div class="language-css vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">css</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">/** </span></span>
